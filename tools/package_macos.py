...
info={'CFBundleName':'Iron Coast: Scrap Tide','CFBundleDisplayName':'Iron Coast: Scrap Tide','CFBundleIdentifier':'games.kiyihurdasi.desktop','CFBundleVersion':'0.2.3','CFBundleShortVersionString':'0.2.3','CFBundleExecutable':'kiyi_hurdasi','CFBundlePackageType':'APPL','NSHighResolutionCapable':True,'NSSupportsAutomaticGraphicsSwitching':True}
