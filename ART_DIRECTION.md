# Iron Coast — cinematic art pass, 0.2
...
The existing boss and vehicle atlas mappings were not reauthored in this art pass.
...
- Atlas checks cover transparent borders and common foot anchors for all 112 packed cells, full run-pose bounds, and reproducibility from the checked-in source maps.
